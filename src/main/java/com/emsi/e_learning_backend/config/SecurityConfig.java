...
import com.emsi.e_learning_backend.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/courses/professor/**").permitAll()
                        .requestMatchers("/api/courses/create").hasAuthority("PROFESSOR")
                        ...
                        .requestMatchers("/assets/videos/**").permitAll()
